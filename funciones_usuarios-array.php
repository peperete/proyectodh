<?php
  ...
  class Usuario {
    ...
    function validarRegistroUsuario ($usuario, $modo="json", $usuarioModificar=false){
      $errores = [];
      ...
      if($usuarioModificar==false){
    		...
    		if (Usuario::existeElUsuario($usuario["email"], $modo)) {
    ...
    private function existeElUsuario($email, $modo = "json"){
      if ($modo = "json") {
